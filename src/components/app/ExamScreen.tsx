        ...
        <EmptyState
          ...
          action={
            <>
              ...
              <GhostButton onClick={() => setStatus('welcome')}>返回首页</GhostButton>
            </>
          }
        />
      </motion.div>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`flex items-center gap-1 px-2 py-1 text-[10px] font-bold rounded-md transition-colors ${
                    currentUser ? 'bg-blue-100 text-blue-600 hover:bg-blue-200' : 'bg-slate-100 text-slate-400 cursor-not-allowed'
                  }`}
                  title="导入题库"
                >
                  <Upload size={12} /> 导入
